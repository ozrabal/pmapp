...
export function ProjectsEmptyState({ onCreateNew }: ProjectsEmptyStateProps) {
  ...
  return (
    ...
    >
      ...
      <h3 className="font-semibold text-lg mb-2">Nie masz jeszcze żadnych projektów</h3>

      <p className="text-muted-foreground max-w-md mb-6">
        Utwórz swój pierwszy projekt, aby rozpocząć pracę nad swoim pomysłem. Możesz tworzyć, edytować i zarządzać
        wieloma projektami.
      </p>
