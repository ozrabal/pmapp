...
// Reference to the 'users' table managed by Supabase Auth
export const users = pgTable("users", {
  id: uuid().primaryKey().notNull(),
  // This is a reference table for the Supabase Auth 'users' table
  // Other fields are not defined here since they are managed by Supabase
});
