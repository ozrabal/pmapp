...
DO $$
BEGIN
	IF NOT EXISTS (SELECT 1 FROM pg_type WHERE typname = 'estimation_unit_enum') THEN
...
DO $$
BEGIN
	IF NOT EXISTS (SELECT 1 FROM pg_type WHERE typname = 'task_dependency_type_enum') THEN
...
ALTER TABLE IF EXISTS "ai_suggestion_feedbacks" ENABLE ROW LEVEL SECURITY;
...
CREATE INDEX IF NOT EXISTS "ai_suggestion_feedbacks_user_id_idx" ON "ai_suggestion_feedbacks" USING btree ("user_id");
...
CREATE INDEX IF NOT EXISTS "idx_profiles_default_estimation_unit" ON "profiles" USING btree ("default_estimation_unit");
CREATE INDEX IF NOT EXISTS "gin_projects_functional_blocks" ON "projects" USING gin ("functional_blocks");
CREATE INDEX IF NOT EXISTS "gin_projects_schedule" ON "projects" USING gin ("schedule");
CREATE INDEX IF NOT EXISTS "idx_projects_estimation_unit" ON "projects" USING btree ("estimation_unit");
...
CREATE INDEX IF NOT EXISTS "gin_tasks_metadata" ON "tasks" USING gin ("metadata");
CREATE INDEX IF NOT EXISTS "idx_tasks_deleted_at" ON "tasks" USING btree ("deleted_at");
CREATE INDEX IF NOT EXISTS "idx_tasks_estimated_by_ai" ON "tasks" USING btree ("estimated_by_ai");
CREATE INDEX IF NOT EXISTS "idx_tasks_functional_block_id" ON "tasks" USING btree ("functional_block_id");
CREATE INDEX IF NOT EXISTS "idx_tasks_priority" ON "tasks" USING btree ("priority");
CREATE INDEX IF NOT EXISTS "idx_tasks_project_functional_block" ON "tasks" USING btree ("project_id","functional_block_id");
